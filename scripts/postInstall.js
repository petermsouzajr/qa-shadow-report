...
const createConfigFile = (framework = 'cy') => {
  const testData = framework === 'pw'
  ...
  if (fs.existsSync(configFilePath)) {
    ...
    const config = {
      ...
      // Results JSON. Cypress: ./cypress/results/output.json  Playwright: ./test-results/output.json
      testData: '${testData}',
